...
from hack_rest.chatbot.bot import ChatBot, classify_top_n_finetuned, translate_to_english, translate_to_hindi
...
from hack_rest.route.group.models.group_register_model import CHATBOT_USER_INTRACTION_MODEL
        ...
        try:
            ...
            if intent == "classify":
                ...
                if not top_matches:
                    ...
                    response_hi = translate_to_hindi(response_en) if lang == "hi" else response_en
                ...
                chat_reply = translate_to_hindi(chat_reply) if lang == "hi" else chat_reply
